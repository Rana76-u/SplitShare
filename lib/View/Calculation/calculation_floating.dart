...
import 'package:splitshare_v3/View/Calculation/viewpdf.dart';
      ...
      child: FittedBox(
        child: FloatingActionButton.extended(
          onPressed: () async {
            ...
            final pdfFile = await PdfTripReportApi.generate(tripReport, '${await TripInfoManager().getTripName()}.pdf' );
